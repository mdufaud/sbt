...
architectures = {
    ...
    "arm32":       {"gcc": {"gnu": "arm-linux-gnueabihf-",      "musl": "arm-linux-musleabihf-"},     "gnu_alts": ["arm-linux-gnueabihf-", "arm-none-linux-gnueabihf-"], "zig": "arm-linux-musleabihf",   "zig_flags": "-mcpu=generic+v7a", "vcpkg": "arm",   "meson": {"cpu_family": "arm",        "cpu": "armv7",      "endian": "little"}},
...
def normalize_machine(machine: str) -> str:
    return machine_aliases.get(machine.lower(), machine)
